...
function getCardTitelAndPrice6() {
    ...
    // set titel
    const titel = cardTitel('card-titel-7');
    const prdctList = document.getElementById('prdct-list');
    const li = document.createElement('li');
    li.innerText = titel
    prdctList.appendChild(li);
    ...
    // set price
    const price = cardPrice('card-price-7');
    const previousTP = previousTotalTDT('previous-total-price');
...
// card 8
function getCardTitelAndPrice8() {

    // set titel
    const titel = cardTitel('card-titel-8');
    const prdctList = document.getElementById('prdct-list');
    const li = document.createElement('li');
    li.innerText = titel
    prdctList.appendChild(li);
    ...
    // set price
    const price = cardPrice('card-price-8');
    const previousTP = previousTotalTDT('previous-total-price');
...
// card 9
function getCardTitelAndPrice9() {

    // set titel
    const titel = cardTitel('card-titel-9');
    const prdctList = document.getElementById('prdct-list');
    const li = document.createElement('li');
    li.innerText = titel
    prdctList.appendChild(li);
    ...
    // set price
    const price = cardPrice('card-price-9');
    const previousTP = previousTotalTDT('previous-total-price');
